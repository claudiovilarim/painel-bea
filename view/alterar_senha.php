...
<body>
  ...
  <div class="container">
    <h2>Alterar senha</h2>
    <form action="../controller/usuarioAlterarSenha.php" method="POST">
      <div class="form-group">
        <input type="hidden" name="id" value="<?= $_SESSION['id_usuario']; ?>">
        <label for="nome">Nome</label>
        <input type="text" class="form-control" id="nome" name="nome" value="<?= $_SESSION['nomeUsuario']; ?>" disabled>
        <label for="senha">Senha Atual</label>
        <input type="password" class="form-control" id="senha" name="senhaAtual" required>
